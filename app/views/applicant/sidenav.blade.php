<div class="side-nav fixed " style="margin-top: 4.3em; width:22rem; background:#eff0f1">
    <div class="sideNav ">
            <div class="collection " style="border:0">
                <a class="collection-item " href="{{ asset('/applicant/shortlist/') }}">Employer List<i class="mdi mdi-briefcase-download small right "></i></a>
                <a class="collection-item " href="{{ asset('/applicant/shortlist/') }}">Shortlist<i class="mdi mdi-format-list-bulleted small right "></i></a>
